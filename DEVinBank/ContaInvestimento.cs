...
namespace DEVinBank
{
    public class ContaInvestimento : Conta
    {
        ...
        public void DepositoInvestimento(double value, string tipoAplicacao)
        {
            ...
            switch (tipoAplicacao)
            {
                ...
                case "CDB":
                    ...
                    if (((dateSpan3.Years*12)+ dateSpan3.Months)> 36) Saldo = (Saldo * (Math.Pow((1.0 + (0.08 / 12)), dateSpan1.Months)));
                    base.Deposito(value);
